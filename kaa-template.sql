...
INSERT INTO `abstract_structure` VALUES (1,${TIMESTAMP},'${ADMIN_USERNAME}',${TIMESTAMP},'${ADMIN_USERNAME}',0,NULL,'Generated',0,${TIMESTAMP},NULL,1,'ACTIVE',1,1,1),(2,${TIMESTAMP},'${DEVELOPER_USERNAME}',${TIMESTAMP},'${DEVELOPER_USERNAME}',0,NULL,'Generated',0,${TIMESTAMP},NULL,1,'ACTIVE',1,1,1);
...
INSERT INTO `admin_properties` VALUES (1,'org.kaaproject.kaa.server.admin.services.entity.gen.SmtpMailProperties',_binary 'BKaa <admin@localhost.localdomain>smtp.gmail.com¢\0†ú\0\0\0 haeyun@gmail.com\0aq17531234'),(2,'org.kaaproject.kaa.server.admin.services.entity.gen.GeneralProperties',_binary 'Kaa*http://localhost:8080');
...
INSERT INTO `admin_user` VALUES (1,_binary '',NULL,NULL,NULL,'${KAA_PASSWORD}',NULL,_binary '\0','${KAA_USERNAME}'),(2,_binary '',NULL,NULL,'${ADMIN_MAIL}','${ADMIN_PASSWORD}',NULL,_binary '\0','${ADMIN_USERNAME}'),(3,_binary '',NULL,NULL,'${DEVELOPER_MAIL}','${DEVELOPER_PASSWORD}',NULL,_binary '\0','${DEVELOPER_USERNAME}');
...
INSERT INTO `application` VALUES (1,'${APP_TOKEN}','Trustful','${APP_NAME}',2,1);
...
INSERT INTO `base_schems` VALUES (1,${TIMESTAMP},'${ADMIN_USERNAME}',NULL,'Generated',0,1,1),(2,${TIMESTAMP},'${ADMIN_USERNAME}',NULL,'Generated',1,1,1),(3,${TIMESTAMP},'${ADMIN_USERNAME}',NULL,'Generated',0,1,1),(4,${TIMESTAMP},'${ADMIN_USERNAME}',NULL,'Generated',1,1,1),(5,${TIMESTAMP},'${ADMIN_USERNAME}',NULL,'Generated',1,1,1),(6,${TIMESTAMP},'${DEVELOPER_USERNAME}',NULL,'Log Schemas',2,1,2),(7,${TIMESTAMP},'${DEVELOPER_USERNAME}',NULL,'Configuration Schemas',2,1,3);
...
INSERT INTO `endpoint_group` VALUES (1,${TIMESTAMP},'${ADMIN_USERNAME}',NULL,0,'All',0,0,1);
...
INSERT INTO `header_structure` VALUES (2,'KEYHASH'),(2,'VERSION'),(2,'TIMESTAMP'),(2,'TOKEN'),(2,'LSVERSION');
...
INSERT INTO `history` VALUES (1,${TIMESTAMP},1,1,1),(2,${TIMESTAMP},2,1,2);
...
INSERT INTO `kaa_user` VALUES (1,'TENANT_ADMIN','2','${ADMIN_USERNAME}',1),(2,'TENANT_DEVELOPER','3','${DEVELOPER_USERNAME}',1);
...
INSERT INTO `log_appender` VALUES (_binary '',2147483647,1,2);
...
INSERT INTO `plugin` VALUES (1,${TIMESTAMP},'${DEVELOPER_USERNAME}','','User Verifier','org.kaaproject.kaa.server.verifiers.trustful.verifier.TrustfulUserVerifier','Trustful verifier','',1),(2,${TIMESTAMP},'${DEVELOPER_USERNAME}','','My MariaDB','org.kaaproject.kaa.server.appenders.maria.appender.MariaDbLogAppender','MariaDB','^B^Rlocalhost‘3\0^Fkaa^Psqladmin\nadmin^T^T\0',1);
...
INSERT INTO `sdk_token` VALUES (1,2,${TIMESTAMP},'${DEVELOPER_USERNAME}','${USER_VERIFIER}',0,2,'${SDK_NAME}',1,0,'${SDK_TOKEN}',1);
...
INSERT INTO `tenant` VALUES (1,'${TENANT}');
...
INSERT INTO `user_verifier` VALUES ('${USER_VERIFIER}',1);
